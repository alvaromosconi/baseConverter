 ...
 * @return Puntero a float que apunta al numero fraccional ya convertido a base 10.
 *
 */
 ...
 * @param detailed
          Puntero a entero que aputna al numero 1 si el usuario ingreso el parametro "-v", 0 si el usuario no ingreso el parametro "-v".
